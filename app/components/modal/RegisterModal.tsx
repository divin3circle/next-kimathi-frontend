...
const RegisterModal = () => {
  ...
  return (
    <Modal disabled={isLoading} isOpen={registerModal.isOpen} title="Join Us" actionLabel="Continue" onClose={registerModal.onClose} onSubmit={handleSubmit(onSubmit)} body={bodyContent} />
  )
};
